...
public class PokemonBase  extends PokemonAbstract {
     ...
     */
    public PokemonBase(String fileName, AbilityDict abilityDict,MoveDict moveDict,Pokedex pokedex) throws IOException, FileFormatException, AbilityNotFoundException, MoveNotFoundException, PokemonNotFoundException {
        File file = new File("D:\\Documents\\Programmation\\Pokemon_Replique_Files(Java)\\PokemonClone\\SourceFiles\\Pokemons\\" + fileName);
        ...
        while (line != null) {
            st = line.split(" , ");
            //reading blank lines until something is found
            while (line.compareTo("") == 0) line = br.readLine();
           ...
           */
            switch (st[0].toLowerCase()) {
                ...
                case "gender ratio":
                    ...
                    if (ratio[1]==null || ratio[0].compareTo("")==0 || ratio[1].compareTo("")==0) throw new FileFormatException(fileName);
                ...
                case "evolution id":
                    ...
                    pokedex.getPokemonByID(Integer.parseInt(st[1]));
        ...
        if (types==null || name==null || EV==null || IV==null || stats==null || description==null || weight==0.0f || height==0.0f || catchRate==0 || baseExp==0 || lvlRate==null){
        ...
        while(line!=null && continueReading){
           ...
           if (beginReading){
               ...
               if(dictLVLMoves.containsKey(lvl)){
                   ...
                   ArrayList<Move> movesTemp = dictLVLMoves.get(lvl);
                   movesTemp.add(move);

                   //Replacing the old ArrayList
                   dictLVLMoves.replace(lvl,movesTemp);
               }
               else {
               ...
               if (line.charAt(line.length()-1)=='}') continueReading=false;
